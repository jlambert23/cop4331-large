...
INSERT INTO users VALUES('1','Stringer', 'Bell','SBell','goFYaself@gmail.com','password','5555555555','Bla bla description','picture path here');
INSERT INTO users VALUES('2','Lebron', 'James','LBJ','LBJ@gmail.com','ImTheGreatest','5555555555','Bla bla description','picture path here');
INSERT INTO users VALUES('3','Tony', 'Soprano','TonyS','capicolaLover@gmail.com','PieOMy','5555555555','Bla bla description','picture path here');
INSERT INTO users VALUES('4','Christopher','Moltisanti','ChrisM','heroinAddict@gmail.com','Adrian','5555555555','Bla bla description','picture path here');
INSERT INTO users VALUES('5','Dwayne','Wade','DWade','MiamiStyle@gmail.com','WadeandLebron','5555555555','Bla bla description','picture path here');
INSERT INTO users VALUES('6','Carmello','Anthony','Mello','BigAppleBaller@gmail.com','1password','5555555555','Bla bla description','picture path here');
INSERT INTO users VALUES('7','Don','Draper','MarketingMan','alcoholic@aol.com','2password','5555555555','Bla bla description','picture path here');
